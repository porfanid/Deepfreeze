"""Integration tests for Deep Freeze CLI."""
...
class TestCLI:
    ...
    def test_snapshot_create(self):
        ...
        result = self.runner.invoke(
            cli,
            ['--base-path', str(self.base_path), 'snapshot', 'create', 'test_snap']
        )
    ...
    def test_snapshot_list(self):
        ...
        result = self.runner.invoke(
            cli,
            ['--base-path', str(self.base_path), 'snapshot', 'list']
        )
    ...
    def test_set_default(self):
        ...
        result = self.runner.invoke(
            cli,
            ['--base-path', str(self.base_path), 'set-default', 'default_snap']
        )
    ...
    def test_status_json_output(self):
        ...
        result = self.runner.invoke(
            cli,
            ['--base-path', str(self.base_path), 'status', '--json-output']
        )
